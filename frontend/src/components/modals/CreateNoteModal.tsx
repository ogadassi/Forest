...
export const CreateNoteModal: React.FC<CreateNoteModalProps> = ({ isOpen, onClose, onNoteCreated, categoryId }) => {
    ...
    const themeColor = noteColor || 'var(--color-primary)';
            ...
            >
                ...
                <div className="flex items-center justify-between px-8 py-5 shrink-0 z-10 relative">
                    <div className="flex items-center gap-2.5 opacity-80">
                        <span className="material-icons-round text-lg" style={{ color: themeColor }}>post_add</span>
                        <span className="text-[10px] font-black uppercase tracking-[0.15em] text-slate-300">NEW NOTE</span>
                    </div>
